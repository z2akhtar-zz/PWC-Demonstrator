...
#define PORT_PIN_FEC_MDIO_IO	   34
#define PORT_PIN_FEC_MDIO_MSCR_IO  (924 - 512)
#endif
...
FecLinkState  linkState = LINK_DOWN;
...
#define PIN_FPGA_DP_RST	205
	...
	SIUL2.MSCR[PORT_PIN_FEC_MDIO_IO].R =      0x31090003u;   /* Set to FEC_MDIO	 */
	SIUL2.PSMI[PORT_PIN_FEC_MDIO_MSCR_IO].R = 0x00080001u;	/*FEC_MDIO input pad */
#endif
