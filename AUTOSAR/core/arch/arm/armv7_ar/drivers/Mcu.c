...
#define SRCSEL_ARM_CLK_CTRL_ARM_PLL		0
#define SRCSEL_ARM_CLK_CTRL_DDR_PLL		2
#define SRCSEL_ARM_CLK_CTRL_IO_PLL		3

/* Used for other clock control registers */
#define SRCSEL_ARM_PLL     2
#define SRCSEL_DDR_PLL     3
#define SRCSEL_IO_PLL      0
...
static uint32 zynq_GetRevision( void ) {
	return ((DEVCFG_REG.MCTRL & 0xf0000000) >> 28);
}
