...
#define GPT_CHANNELS_CNT       4
#elif defined(CFG_MPC5604B)
#define GPT_CHANNELS_CNT       5
#elif defined(CFG_MPC5606B)  || defined(CFG_MPC5645S)
#define GPT_CHANNELS_CNT       7
#else
#define GPT_CHANNELS_CNT       8
#endif

#define GPT_CHANNEL_PIT_LAST    (GPT_CHANNELS_CNT-1)
...
#if defined(CFG_MPC560X) || defined(CFG_MPC563XM) || defined(CFG_MPC5744P) || defined(CFG_MPC5645S) || defined(CFG_MPC5643L) || defined(CFG_SPC56XL70) || defined(CFG_MPC5777M)
