...
#if defined(CFG_MPC5604P) || defined(CFG_MPC5744P) || defined(CFG_MPC5777M)
...
#if defined(CFG_MPC5604P) || defined(CFG_MPC5744P) || defined(CFG_MPC5777M)
    uint16 factor = Mcu_Arc_GetSystemClock() / Mcu_Arc_GetPeripheralClock(PERIPHERAL_CLOCK_PIT_3);
	PIT.MCR.B.MDIS = 0;
	PIT.MCR.B.FRZ = 1;

	PIT.CH[3].LDVAL.R = period_ticks / factor; /* period_ticks = sys_freq/OsTickFreq; Timeout= 64000 sysclks x 1sec/64M sysclks = 1 ms */
