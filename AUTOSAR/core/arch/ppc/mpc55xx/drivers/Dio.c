...
Dio_LevelType Dio_ReadChannel(Dio_ChannelType channelId)
{
    ...
    } else if((SIU.PCR[channelId].B.ODC) != 0u) {
#else
    } else if(SIU.PCR[channelId].B.OBE != 0u) {
#endif
        // Read level from SIU.
        if (SIU.GPDO [channelId].R != 0u) {
            level = STD_HIGH;
        }
    }
    /*lint -restore*/
...
Dio_PortLevelType Dio_ReadPort(Dio_PortType portId)
{
    ...
    /** @req:PPC|MPC5607B SWS_Dio_00053 */
    /** @req:PPC|MPC5607B SWS_Dio_00031 */
    /** @req:PPC|MPC5607B SWS_Dio_00013 */
    /** @req PPC|MPC5607B SWS_Dio_00051 */
    ...
    /** @req:PPC|MPC5607B SWS_Dio_00075 */
...
{
    /** @req:PPC|MPC5607B SWS_Dio_00034 */
    /** @req:PPC|MPC5607B SWS_Dio_00053 */
    /** @req:PPC|MPC5607B SWS_Dio_00007 */
    /** @req:PPC|MPC5607B SWS_Dio_00051 */
    ...
    /** @req:PPC|MPC5607B SWS_Dio_00105 Note: No check for endianess */
...
Dio_PortLevelType Dio_ReadChannelGroup(const Dio_ChannelGroupType *channelGroupIdPtr)
{
    ...
    /** @req:PPC|MPC5607B SWS_Dio_00056 */
    /** @req:PPC|MPC5607B SWS_Dio_00014 */
    /** @req:PPC|MPC5607B SWS_Dio_00037 Depends on the generator */
    /** @req:PPC|MPC5607B SWS_Dio_00092 */
    /** @req:PPC|MPC5607B SWS_Dio_00093 */
    /** @req:PPC|MPC5607B SWS_Dio_00051 */

    Dio_PortLevelType level;
    VALIDATE_RV( DioGlobal.InitRun, DIO_READCHANNELGROUP_ID, DIO_E_UNINIT, (Dio_PortLevelType)0u );
    /** @req:PPC|MPC5607B SWS_Dio_00114 */
...
void Dio_WriteChannelGroup(const Dio_ChannelGroupType *channelGroupIdPtr, Dio_PortLevelType level) {
    ...
    /** @req:PPC|MPC5607B SWS_Dio_00056 */
    /** @req:PPC|MPC5607B SWS_Dio_00008 */
    /** @req:PPC|MPC5607B SWS_Dio_00039 Depends on the generator */
    /** @req:PPC|MPC5607B SWS_Dio_00040 */
    /** @req:PPC|MPC5607B SWS_Dio_00090 */
    /** @req:PPC|MPC5607B SWS_Dio_00091 */
    /** @req:PPC|MPC5607B SWS_Dio_00051 */
...
void Dio_WriteChannel(Dio_ChannelType channelId, Dio_LevelType level) {
    ...
    /*lint -save -e923 False positive */
#if defined (CFG_MPC5777M)
    if (SIU.PCR[channelId].B.ODC != 0u) {
#else
    if (SIU.PCR[channelId].B.OBE != 0u) {
#endif
