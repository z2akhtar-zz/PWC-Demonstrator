...
/* Not aligned reads */
#define READ32_NA(address )			( (((uint32)(((uint8_t *)address)[0]))<<24) +	\
									  (((uint32)(((uint8_t *)address)[1]))<<16) +	\
									  (((uint32)(((uint8_t *)address)[2]))<<8) +	\
									  ((uint32)(((uint8_t *)address)[3])) )

#define READ16_NA(address )			( (((uint16)(((uint8_t *)address)[0]))<<8) +	\
									  (((uint16)(((uint8_t *)address)[1]))) )
