...
typedef Std_ReturnType (*Dcm_FixLenCallbackWriteDataFncType)(const uint8 *data, Dcm_OpStatusType opStatus, Dcm_NegativeResponseCodeType *errorCode);
...
typedef Std_ReturnType (*Dcm_FuncCallbackShortTermAdjustmentFncType)(const uint8 *controlOptionRecord, Dcm_OpStatusType OpStatus, Dcm_NegativeResponseCodeType *errorCode);
...
typedef struct {
    ...
    Dcm_CallbackReadDataLengthFncType           DspDataReadDataLengthFnc;        // (0..1)   /** @req DCM671 */
    Dcm_CallbackConditionCheckReadFncType       DspDataConditionCheckReadFnc;    // (0..1)   /** @req DCM677 */
    Dcm_CallbackReadDataFncType                 DspDataReadDataFnc;              // (0..1)   /** @req DCM669 */
    Dcm_CallbackWriteDataFncType                DspDataWriteDataFnc;             // (0..1)   /** @req DCM670 */
    Dcm_CallbackGetScalingInformationFncType    DspDataGetScalingInfoFnc;        // (0..1)   /** @req DCM676 */
    Dcm_CallbackFreezeCurrentStateFncType       DspDataFreezeCurrentStateFnc;    // (0..1)   /** @req DCM674 */
    Dcm_CallbackResetToDefaultFncType           DspDataResetToDefaultFnc;            // (0..1)   /** @req DCM673 */
    Dcm_CallbackReturnControlToECUFncType       DspDataReturnControlToEcuFnc;    // (0..1)   /** @req DCM672 */
    Dcm_CallbackShortTermAdjustmentFncType      DspDataShortTermAdjustmentFnc;   // (0..1)   /** @req DCM675 */
...
typedef struct Dcm_DspDidType {
	...
	Dcm_RoeActivateCallbackFncType              DspDidRoeActivateFnc;           // (0..1)   /** @req Dcm782_Conf */
	uint8                                       DspDidRoeEventId;               // (0..1)   /** @req Dcm781_Conf */
	// Containers
	boolean										Arc_EOL;
...
// 10.2.40
typedef struct {
	uint32 DspStartRoutineCtrlOptRecSize;	// (1)	/** @req DCM654 */
	uint32 DspStartRoutineStsOptRecSize;		// (1)	/** @req DCM655 */
 ...
 * DSD *
 *******/
typedef Std_ReturnType (*DsdSubServiceFncType)(Dcm_OpStatusType opStatus, Dcm_MsgContextType *msg);
