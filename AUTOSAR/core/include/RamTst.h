...
#define RAMTST_INIT_SERVICE_ID 0x0u
#define RAMTST_DEINIT_SERVICE_ID 0xcu
#define RAMTST_STOP_SERVICE_ID 0x2u
#define RAMTST_ALLOW_SERVICE_ID 0x3u
#define RAMTST_GETVERSIONINFO_SERVICE_ID 0x0au
#define RAMTST_SUSPEND_SERVICE_ID 0xdu
#define RAMTST_RESUME_SERVICE_ID 0xeu
#define RAMTST_GETEXECUTIONSTATUS_SERVICE_ID 0x4u
#define RAMTST_GETTESTRESULT_SERVICE_ID 0x5u
#define RAMTST_GETRESULTPERBLOCK_SERVICE_ID 0x6u
#define RAMTST_GETALGPARAMS_SERVICE_ID 0x12u
#define RAMTST_GETTESTALGORITHM_SERVICE_ID 0x7u
#define RAMTST_GETNUMBEROFTESTEDCELLS_SERVICE_ID 0x9u
#define RAMTST_SELECTALGPARAMS_SERVICE_ID 0xbu
#define RAMTST_CHANGENUMBEROFTESTEDCELLS_SERVICE_ID 0x8u
#define RAMTST_RUNPARTIALTEST_SERVICE_ID 0x11u
#define RAMTST_MAINFUNCTION_SERVICE_ID 0x1u
...
#define RAMTST_SERVICEID_INIT           0x00u
#define RAMTST_SERVICEID_STOP           0x02u
#define RAMTST_SERVICEID_ALLOW          0x03u
#define RAMTST_SERVICEID_DEINIT         0x0cu
#define RAMTST_SERVICEID_RUNFULLTEST    0x10u
