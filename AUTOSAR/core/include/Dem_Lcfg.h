...
typedef struct {
    ...
    uint8                           IndicatorId;
	Dem_IndicatorStatusType	        IndicatorBehaviour;
    uint8                           IndicatorFailureCycleThreshold;
    Dem_OperationCycleStateType     IndicatorFailureCycle;
...
typedef struct {
	...
	const Dem_FreezeFrameClassType				*FreezeFrameClassRef; 		// (0..1) (Only 0..1 supported)
