...
/** @req COMM469 */
#define COMM_AR_MAJOR_VERSION       4u
#define COMM_AR_MINOR_VERSION       0u
#define COMM_AR_PATCH_VERSION       3u
...
#define COMM_E_ERROR_IN_PROV_SERVICE    0x3u /**< Provided API services of other modules returned with an error. */
