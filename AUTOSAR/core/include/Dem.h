...
#define DEM_SW_MAJOR_VERSION    4u
...
#define DEM_E_EVENT_STATUS_BUFF_FULL        0x51u
...
#define DEM_DISABLEDTCSTORAGE_ID				0x24u
#define DEM_ENABLEDTCSTORAGE_ID					0x25u

#define DEM_GETFREEZEFRAMEDATARECORDBYDTC_ID		0x26u
#define DEM_GETFREEZEFRAMEDATAIDENTIFIERBYDTC_ID		0x27u
...
#define DEM_SETFREEZEFRAMERECORDFILTER_ID       0x37u
