...
#define MCU_AR_RELEASE_MINOR_VERSION        1u
#define MCU_AR_RELEASE_PATCH_VERSION        2u
...
#define MCU_LOSS_OF_CLOCK_SERVICE_ID        0x0Bu  // Not in spec but follows pattern
...
#define MCU_GETRESETRAWVALUE_NORESETREG_RV  0x00U         /* Not used for PPC. Raw reset value is supported */
...
typedef uint64 Mcu_RawResetType;
#else
